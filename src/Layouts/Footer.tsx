      ...
      <div className="grid grid-cols-3 gap-4 py-8 px-7">
        <div>
          ...
          <p className="text-zinc-500">
            Portal oficial de notícias do estado, mantendo a população informada
            sobre os principais acontecimentos com credibilidade e
            transparência.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="flex flex-col">
            <a href="#" className="text-zinc-500 hover:text-gray-900">
              Prefeitura
            </a>
            <a href="#" className="text-zinc-500 hover:text-gray-900">
              Câmara Municipal
